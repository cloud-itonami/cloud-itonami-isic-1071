# Operator Quickstart — Bakery Products Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1071** (`cloud-itonami-isic-1071`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1071.git
cd cloud-itonami-isic-1071
```
...
- Blueprint governor key: `bakery-governor`
- Likely source path: `bakeryops.governor.cljc`
