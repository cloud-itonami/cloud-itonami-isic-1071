# Business Model: Bakery Products Coordination
...
## Classification
- Repository: `cloud-itonami-isic-1071` ([github.com/cloud-itonami/cloud-itonami-isic-1071](https://github.com/cloud-itonami/cloud-itonami-isic-1071))
- ISIC Rev.5: `1071` — Bakery Products Coordination
- Domain: `:food/bakery-products`
- Social impact: :food-security :food-safety :fair-labor
- Actor: `:bakery-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :food/bakery-products — who wants
...
One managed tenant (:food/bakery-products):
...
- Do not bypass the `:bakery-governor` for production decisions.
